  ...
  <v-app id="inspire">
    ...
    >
      <v-container class="py-0 fill-height">
        ...
        <v-btn @click="$router.push('/')">Inicio Agenda</v-btn> 
          ...
          <v-col cols="2">
            ...
            <v-list color="transparent">
                ...
                <v-card class="mx-auto" max-width="143" margin="50px">
                    ...
                    height="200px"
                    ></v-img>
                    <v-card-title>Ana</v-card-title>

                    <v-card-subtitle>
                    <v-list-item two-line>
                    <v-list-item-content>
                        <v-list-item-title>Servicios:</v-list-item-title>
                        <v-list-item-subtitle>Maquillaje</v-list-item-subtitle>
                        <v-list-item-subtitle>Tintura</v-list-item-subtitle>
                    </v-list-item-content>
                    </v-list-item>
                    </v-card-subtitle>
                </v-card>
